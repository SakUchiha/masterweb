  ...
  try {
    ...
    try {
      ...
      const possiblePaths = [
        ...
        path.join(process.cwd(), "vibing", "code-understanding-app", "backend", "server.js", "data", "lessons.json"),
      ];
    ...
    // Use the full lessons data from the backend server.js data file
    try {
      lessons = require("../vibing/code-understanding-app/backend/server.js/data/lessons.json");
      console.log(`Successfully loaded ${lessons.length} lessons from backend data file`);
    } catch (backendError) {
      console.warn("Could not load backend lessons file either:", backendError.message);
      ...
      lessons = [
        ...
        },
        {
          ...
          "difficulty": "Beginner",
          "duration": "30 minutes",
          "summary": "Learn CSS basics, including selectors, properties, and styling.",
          "description": "CSS (Cascading Style Sheets) controls the visual appearance of web pages. Learn about CSS syntax, selectors, properties, and how to style your HTML.",
          "slides": [
            {
              "id": 1,
              "title": "What is CSS?",
              "content": "<h2>What is CSS?</h2><p>CSS stands for Cascading Style Sheets.</p><p>It controls the visual presentation of HTML elements.</p>",
              "type": "content"
            }
          ],
          "learningObjectives": [
